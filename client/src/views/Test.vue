    ...
    <wrapper>
        <div>
            <v-content>
                <v-container>
                    <!--Header-->
                    <v-card :loading="loading" class="mx-auto my-12" max-width="1000" height = "auto">
                        <v-card-title>
                        ...
                        <v-card-text>
                            ...
                            <v-btn flat color="deep-purple accent-4 white--text" @click="toggleSpeech()" style="float: left">
                    ...
                    <v-card :loading="loading" class="mx-auto my-12" max-width="1000" height = "auto">
                        ...
                        <v-textarea solo name="input-7-4" label="Write your story here or tell it using our speech-to-text button above." 
                            rows="10" auto-grow counter v-model="text" :value="comment">
                        </v-textarea>
                    </v-card>
                    <!--Publish Button-->
                    <v-btn large 
